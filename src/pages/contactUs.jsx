                    ...
                    <div className="row mt-4">
                        <div className="col-md-6">
                            <div className="contact-info mb-5">
                                ...
                                <p className="text-lead"><span className="toya-color me-2"><FontAwesomeIcon icon={["far", "envelope"]} /> </span > <span className="fw-bold">Mail  :</span>  support@toyanaturals.com</p>
                            </div>
                        </div>
                        <div className="col-md-6">
