          ...
          <div className="row mt-4">
            <div className="col-md-6">
              <div className="contact-info mb-5">
                ...
                <p className="text-lead mt-3 mb-2"><span className="toya-color"><FontAwesomeIcon icon={["fas", "clock-rotate-left"]} />  </span>Working hours : We aim to respond within 24hrs.</p>
                <p className="text-lead mb-2"><span className="toya-color"><FontAwesomeIcon icon={["fas", "phone"]} />  </span>Phone : +201101899338</p>
                <p className="text-lead"><span className="toya-color"><FontAwesomeIcon icon={["fas", "envelope"]} /> </span>Mail  : support@toyanaturals.com</p>
              </div>
            </div>
            <div className="col-md-6">
              <div className="p-4 p-lg-5  contact-form ">
                {/* <h3 className="toya-color h4">Drop Us</h3> */}
                <h4 className="mt-3 mb-4 text-lead h6 toya-color">We will get back to you shortly.</h4>
